    ...
    public partial class frmClientes : Form
    {
        ...
        private void tsBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (x.DialogResult == DialogResult.OK)
            {
                ...
                txtAPaterno.Text = x.dgClientes.SelectedRows[0].Cells["ApellidoPaterno"].Value.ToString();
                txtAMaterno.Text = x.dgClientes.SelectedRows[0].Cells["ApellidoMaterno"].Value.ToString();
